...
{ int score,max=-INF;int [] v=new int[3];
...
if(depth<MDEPTH){
	...
	if(board[rand1][coloana1-1]=='-') {
					...
					if(v[0]>max)
							{max=v[0];
							if(depth==MAXDEPTH)
							{v[1]=rand1;v[2]=coloana1-1;}}//System.out.println(coloana1);
